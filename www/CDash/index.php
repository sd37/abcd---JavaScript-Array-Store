...
/*=========================================================================
  ...
  Module:    $Id: index.php 2213 2010-02-02 15:03:55Z zach.mullen $
  Language:  PHP
  Date:      $Date: 2010-02-02 15:03:55 +0000 (Tue, 02 Feb 2010) $
...
if(!$db
  ...
  if($CDASH_PRODUCTION_MODE)
    ...
    {
    echo "Message by Girish : executing install.php";
